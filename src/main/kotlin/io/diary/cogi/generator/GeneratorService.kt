...
class GeneratorService(
    ...
    private val prompt: String = """
        ...
        **✅ 출력 형식 (Markdown)**  
        ...
        # 3. 일기  
        오늘은 {작업 요약}에 집중했습니다. <br>  
        {어떤 기능을 개발하거나 수정했는지 자연스럽게 설명}. <br>  
        {개발하면서 고려했던 점}. <br>  
        {이후의 계획}.  
        ```
        ...
        **✅ 예제 출력 (Markdown)**  
        ...
        # 3. 일기  
        오늘은 OAuth 로그인 기능과 게시글 검색 API 개발을 진행했습니다. <br>  
        Kafka를 활용한 이벤트 메시지 발행 기능도 추가했고, <br>  
        기존 코드 구조를 개선하며 리팩토링 작업도 병행했습니다. <br>  
        로그 레벨을 조정하고 디버깅을 강화하는 작업도 진행했습니다. <br>  
        ...
        **📌 유의사항:**  
        ...
        - **일기는 5줄 내외로 자연스럽게 서술**하고 `<br>` 태그를 사용하여 줄바꿈을 유지하세요.  
    """.trimIndent()
